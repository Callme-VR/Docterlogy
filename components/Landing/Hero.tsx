...
export default function Hero() {
  return (
    <section className="relative h-screen flex items-center overflow-hidden pt-20" >
      ...
      <div className="absolute top-20 left-1/4 w-72 h-72 bg-gradient-to-r from-primary/20 to-primary/10 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-gradient-to-r from-primary/15 to-primary/5 rounded-full blur-3xl animate-pulse" />
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/10 to-primary/5 rounded-full border border-primary/20 backdrop-blur-sm">
                  ...
                  <span className="text-sm font-semibold text-primary">AI-Powered Docter Appointment
                  </span>
                </div>

                {/* main heading */}
                <h1 className="text-5xl md:text-5xl lg:text-7xl font-semibold tracking-tight"><span className="bg-gradient-to-br from-foreground via-foreground to-foreground/70 bg-clip-text text-transparent">Your Health
                </span>
                  <br />
                ...
                {/* subtitle or decription  */}
                <p className="text-lg text-muted-foreground leading-relaxed max-w-xl font-medium">
                  Chat with our Ai Doctor Assistant for
                  all your Health problem and Smart ai based Appointment , Available 24/7.
                </p>
                ...
                {/* Rating Star and Testimonial */}
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <div className="flex items-center gap-1">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <StarIcon key={star} className="h-5 w-5 fill-amber-400 text-yellow-400" />
                      ))}
                    </div>
                    <span className="text-sm font-bold text-foreground">4.5/5
                    </span>
                  </div>
                  <p className="text-sm text-muted-foreground">
                    Trusted By {" "}
                    <span className="font-semibold text-foreground">120 + patients</span>
                  </p>
                </div>
