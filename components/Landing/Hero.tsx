...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-20 md:pt-24">
      ...
      <div className="absolute top-20 left-1/4 w-48 h-48 md:w-64 md:h-64 lg:w-72 lg:h-72 bg-gradient-to-r from-primary/20 to-primary/10 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-20 right-1/4 w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 bg-gradient-to-r from-primary/15 to-primary/5 rounded-full blur-3xl animate-pulse" />
