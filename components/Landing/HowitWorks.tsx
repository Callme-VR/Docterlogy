...
export default function HowitWorks() {
  return (
    <section className="relative py-32 px-6 outline-hidden z-10 max-w-7xl mx-auto bg-background">
      <div className="text-center mb-20">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-primary/5 to-primary/10 rounded-full border border-primary/10 backdrop-blur-sm mb-6 animate-pulse">
          <ZapIcon className="size-4 text-primary font-medium" />
          <span className="text-sm font-medium text-primary">
            Simple Process
          </span>
        </div>

        {/* for Bigger Heading of the page */}
