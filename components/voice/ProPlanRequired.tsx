...
// Pro Plan Required Page Component
// This component is displayed when a user tries to access voice assistant features
// without having the required Pro or Basic subscription plan
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 pt-24">
        {/* Access Denied Section - Explains why access is restricted */}
        <div className="relative mb-12 overflow-hidden">
          <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-background rounded-3xl p-8 border border-primary/20">
            <div className="relative z-10 flex items-center justify-between">
              ...
              {/* Decorative Microphone Icon (Hidden on small screens) */}
        ...
        {/* Upgrade Card - Prompts user to upgrade to access feature */}
